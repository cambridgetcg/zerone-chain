...
import (
	...
	"github.com/zerone-chain/zerone/x/creed/keeper"
...
// CLI commands intentionally omitted; the chain operator interacts
// with x/creed via gov-mediated LIPs once that path lands. A simple
// query CLI is a follow-up.
